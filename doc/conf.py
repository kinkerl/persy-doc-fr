# -*- coding: utf-8 -*-
#
# persy documentation build configuration file, created by
...
extensions = ['sphinx.ext.autodoc', 'sphinx.ext.doctest', 'sphinx.ext.todo', 'sphinx.ext.coverage', 'sphinxtogithub']
...
latex_documents = [
  ('index', 'persy.tex', u'persy Documentation',
   u'DS', 'manual'),
]
